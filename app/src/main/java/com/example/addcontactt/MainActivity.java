...
import com.example.addcontactt.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void savedContact() {
        ...
        try {
            ...
            Log.d(TAG, "savedContact: Saved...");
            Toast.makeText(this, "Saved...", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
            Log.d(TAG, "savedContact: "+ e.getMessage());
